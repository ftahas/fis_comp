!
      program threebody_ast
!
      implicit none
!
      integer i,j,k,nt,nb
      real*8 delt,tmin,tmax,t,pi,tau,r12,r13,r23,r,v,gm(3),x(3),y(3),vx(3),vy(3)
!
      open(10,file='threebody_ast.in') 
!
...
!
      close(10) 
!
      open(10,file='posicao_ast.dat') 
      open(20,file='posicao_jupiter.dat') 
! 
      pi=DACOS(-1.0d0)
!
      gm=gm*4.0d0*(pi**2)
...
!
         ...
         r23=r23**3
!
!	 O Sol, partícula 3 fica parado no centro. A órbita de Júpter não é afetada pelo asteróide.
!
